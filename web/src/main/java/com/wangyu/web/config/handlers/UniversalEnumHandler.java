...
import com.platform.common.enums.BaseEnum;
import com.platform.common.enums.ResourceTypeEnum;
 ...
 */
@MappedTypes({ResourceTypeEnum.class, UserTypeEnum.class, StatusTypeEnum.class})
...
// 根据数据库存储类型决定获取类型，本例子中数据库中存放String类型
        String i = resultSet.getString(columnName);
